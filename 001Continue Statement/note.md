...
```
sing continue to avoid pointless work can make your code run faster.
...
Fix the award_enchantments function. It calculates the strength of the enchantment – 5 times the total number of quests completed – and prints a message for the player. But we need to make sure this happens only once for every three quests within the loop!
